...
public class PetStatsController {
    ...
    private void loadPet() {
        ...
        // figure out and display what the pets current mood is based on its stats and display it
    ...
    // mood calculation- will determine the pets mood based on current stat values. lower priority moods are checked first
    public String computeMood(int hunger, int energy, double aff, double bore) {
    ...
    // determines death reason based on which stat hit zero first
